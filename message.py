...
def create_text_message(to, event_to_channel_id, event_type, content_type, send_text):
    return {
       "to": to,
...
def create_rich_messages(to, event_to_channel_id, event_type, content_type, download_url, image_link, json):
    markup_json = {
        "canvas": {
            "width": 1040,
            "height": 1040,
